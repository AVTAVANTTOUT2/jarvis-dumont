...
- Phase 02 : import explicite et TTS Qwen3 isolé autorisés ; aucun micro, STT, LLM distant ou nouveau poids. Diagnostics toujours en lecture seule. Lecture sonore uniquement sur demande explicite, après contrôle de conflit V1.
